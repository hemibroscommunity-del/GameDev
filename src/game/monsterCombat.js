...
import { addBuildUse, applyMeleeLifesteal, clearSwingHitFlags, distributeKillXpToBuild, trackMonsterDamage, pushDmgPopup, monsterPopupY, isPlayerDead, hurtPlayerLocal, isAttackInShieldArc, lockAimPoint, spawnHitDebris /* v2.3.2200; v2.3.2716: its decal twin is retired here */, dropLocalRemnantOnce /* v2.3.2233 */, rangedAimAngle, bowGripPoint /* v2.3.2543 */, BOW_SPECIAL_QUEUE_MS /* v2.3.2473 */ } from '@/game/combatHelpers.js';
            ...
            if (!_lootSwingBlock && !isPlayerDead(S) && !(S._playerStunUntil && Date.now() < S._playerStunUntil)) {
              ...
              if (((_S$rpg0 = S.rpg) === null || _S$rpg0 === void 0 ? void 0 : _S$rpg0.activeSlot) === 'ranged' || ((_S$rpg1 = S.rpg) === null || _S$rpg1 === void 0 ? void 0 : _S$rpg1.activeSlot) === 'staff') {
                ...
                if (isStaff) {
                  ...
                  /* v2.3.2714: drive the staff cast (src/rendering/staffCastFx.js),
          ...
          if (S.isSwinging && !_abilFx && Date.now() - S.swingTimer < 400) {
            ...
            S.monsters.forEach(function (m) {
              ...
              if (_inShape) {
                ...
                /* v2.3.2716: ...and it knows it was a BLADE -- a flat sheet
                ...
                /* ═══ v2.3.2716: THE MATERIAL IS THE HIT EFFECT ═══
