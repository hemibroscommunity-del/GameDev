...
import { depthK } from '@/data/zones.js';   /* v2.3.2775: your reach shrinks with you on Wind Dunes */
        ...
        if (S.monsters && S.rpg) {
          ...
          if (!S.autoAttack && S._engaged && _aSlot === 'melee' && !S._shieldUp
            ...
            if (_eLt && _eLt.alive !== false && !(typeof _eLt.curHp === 'number' && _eLt.curHp <= 0)) {
              ...
              /* v2.3.2775: the body's centre offset and radius shrink with the
              ...
              _engSwing = _eD <= GS_OUTER_RADIUS * meleeRangeMult(S.rpg) * depthK(S.currentZone, P.y); /* v2.3.2592: the engage test reaches as far as the swing does; v2.3.2775: x your depth */
            }
          }
          ...
          if (_aSlot === 'ranged' && S.rpg && _eqWpn && !isPlayerDead(S)) {
            ...
            try {
              _bsHit = firstSightHit(S, _bsX, _bsY, _bsA,
                BOW_RANGE_PX * (bowRangeMult(S.rpg) || 1) * depthK(S.currentZone, P.y), { isStaff: false, isSpecial: false });   /* v2.3.2775: the sight line ends where the (depth-scaled) arrow does */
            } catch (e) { _bsHit = null; }
            ...
            if (!_lootSwingBlock && !isPlayerDead(S) && !(S._playerStunUntil && Date.now() < S._playerStunUntil)) {
              ...
              if (((_S$rpg0 = S.rpg) === null || _S$rpg0 === void 0 ? void 0 : _S$rpg0.activeSlot) === 'ranged' || ((_S$rpg1 = S.rpg) === null || _S$rpg1 === void 0 ? void 0 : _S$rpg1.activeSlot) === 'staff') {
                ...
                S.arrows.push({
                  ...
                  life: isStaff ? Math.round(staffOrbLife(S.rpg) * depthK(S.currentZone, P.y)) : 90,   /* v2.3.2775: an orb's range is its life -- x depth */
                  ...
                  _rangeMult: (isStaff ? 1 : bowRangeMult(S.rpg)) * depthK(S.currentZone, P.y)   /* v2.3.2775: an arrow loosed in the far north lands as far off as it LOOKS */
                });
                ...
                if (S.channel) S.channel.send({ type: 'broadcast', event: 'player_projectile', payload: {
                  ...
                  life: Math.round((isStaff ? staffOrbLife(S.rpg) : 90 * (bowRangeMult(S.rpg) || 1)) * depthK(S.currentZone, P.y)),   /* v2.3.2775: x your depth -- the orb's range is its life */
                }});
          ...
          if (S.isSwinging && !_abilFx && Date.now() - S.swingTimer < 400) {
            ...
            /* v2.3.2775: ...times your depth (zones.js depthK) -- on Wind Dunes'
            ...
            S.monsters.forEach(function (m) {
              ...
              /* v2.3.2775: x the monster's depth -- a mummy drawn at 0.42 on
            ...
            if (S.npcs) {
              S.npcs.forEach(function (npc) {
                ...
                if (nDist > SWING_RANGE * meleeRangeMult(S.rpg) * depthK(S.currentZone, P.y)) return; /* v2.3.2592; v2.3.2775 x depth */
                ...
                if (S.channel) S.channel.send({
                  ...
                  payload: {
                    ...
                    range: Math.min(250, Math.round((wpnType.range || SWING_RANGE)
                      ...
                      * depthK(S.currentZone, P.y))), /* v2.3.2592: melee reach claims its stat too, still clamped; v2.3.2775: x depth (the worker honours min(claim, 250), so claiming less is always safe) */
            ...
            Object.entries(S.others).forEach(function (_ref17) {
              ...
              if (oDist > SWING_RANGE * meleeRangeMult(S.rpg) * depthK(S.currentZone, P.y)) return; /* v2.3.2592; v2.3.2775 x depth */
