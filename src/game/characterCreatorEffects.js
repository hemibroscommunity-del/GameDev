...
export function portraitLook(sel) {
  return {
    ...
    species: sel.speciesSel,   /* v2.3.2682: the monkey; its fur follows the skin above */
...
export function wireCharacterPortrait(previewCanvasRef, sel) {
  ...
  var hairSel = sel.hairSel, facialHairSel = sel.facialHairSel,
    ...
    speciesSel = sel.speciesSel;   /* v2.3.2682: + the species */
  ...
  return drawCharacterPortrait(off, Object.assign(portraitLook(sel), {
    ...
    prewarmPortraitDirs({ hair: hairSel, facialHair: facialHairSel, headwear: headwearSel, eyewear: eyewearSel, eyeStyle: eyeStyleSel, species: speciesSel });   /* v2.3.2643: + the eye style; v2.3.2682: + the species */
