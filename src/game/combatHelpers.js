...
/* ═══ v2.3.2742: ...AND WHAT HIT IT, AND WHERE ═══
...
export function spawnHitDebris(S, m, angle, opts) {
  ...
  S._debrisBursts.push({
    /* v2.3.2743: the tint is the colour the monster is DRAWN in -- a blue
...
/* ═══ v2.3.2730: THE BOLT'S CRASH, IN ONE PLACE ═══
   ...
   real point plus that leftover offset (v2.3.2740). */
...
/* v2.3.2742: no HIT site calls this any more -- the material reaction's
