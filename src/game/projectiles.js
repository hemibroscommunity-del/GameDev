...
function _projImpactFx(S, a, m, fx, tx, ty) {
  ...
  if (fx.stub) {
    if (fx.snap) {
      ...
      /* v2.3.2881: not into a corpse.  Owner: "Arrows stuck in monsters
          ...
          S.arrows = S.arrows.filter(function (a) {
            ...
            if (a.stuckIn) {
              ...
              if (a._landFx) {
                ...
                var _sStep = (a.speedPx != null ? a.speedPx : ARROW_SPEED_PX * (a._rangeMult || 1)) * (S._dtScale || 1);   /* v2.3.2881: a volley lands at its own (slower) speed */
            ...
            if (a._held) {
              ...
              if (a.volley) {
                ...
                if (_vOver > 0) a.dist += (a.speedPx != null ? a.speedPx : ARROW_SPEED_PX * (a._rangeMult || 1)) * _vOver / (1000 / 60);   /* v2.3.2881: at the volley's speedPx */
              }
            }
