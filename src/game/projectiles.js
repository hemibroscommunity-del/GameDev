              ...
              if (_segD < _hitRE) {
                ...
                if (a.isStaff) {
                  ...
                  /* v2.3.2730: the rings and the spray moved into combatHelpers'
                     ...
                     bolts "explode even if they hit props").  v2.3.2714: and the
            ...
            if (_propStop && !a.stuckIn) {
              ...
              if (a.isStaff) {
                ...
                orbCrashFx(S, _impX, _impY, projElem && ELEMENTS[projElem] ? ELEMENTS[projElem].color : '#a78bfa',
                  { elem: projElem || null, vdx: a._fxResX, vdy: a._fxResY });   /* v2.3.2714: the staff cast's crash, where the orb was seen */
