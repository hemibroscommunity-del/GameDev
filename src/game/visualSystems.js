...
export function updateVisualSystems(S) {
        ...
        if (S._remoteProjectiles && S._remoteProjectiles.length > 0) {
          S._remoteProjectiles = S._remoteProjectiles.filter(function(rp) {
            ...
            /* v2.3.2828: ...or, for a bow volley's arrow, a count of frames (gameEvents.js) */
            var _rpWait = false;
            ...
            if (_rpWait) {
              ...
              rp._held = true;   /* v2.3.2828: a bow-volley arrow is not drawn until it is loosed (effectsRenderer) */
              return true;
            }
            rp._held = false;
            /* v2.3.2828: MIRROR-PINNED -- the 8 below is bowVolley.js
