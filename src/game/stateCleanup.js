...
import { PRINT_TTL_MS } from '@/rendering/systems/effectsRenderer.js'; /* v2.3.2647: one TTL, not two */
...
export function updateStateCleanup(S) {
        ...
        /* v2.3.2647: footprints, on the SAME number the renderer fades them
