...
import { MINE_SEAT_DX, MINE_SEAT_DY, FISH_SEAT_DX, FISH_SEAT_DY } from '@/data/constants.js';   /* v2.3.2897 */
...
export function startExtraction(S, node, skill, extra) {
    ...
    if (skill === 'mining' && S.player) {
      /* v2.3.2897: the offsets are MINE_SEAT_DX/DY now (data/constants.js) --
    ...
    if (skill === 'fishing' && S.player) {
      S.player.x = node.x + FISH_SEAT_DX;   /* 52, v2.3.2897: named, as mining's */
