 ...
 */
/* ═══ v2.3.2760: THE CUE GESTURE, THE WAY THE OWNER DESCRIBED IT ═══
 *
...
/* v2.3.2245: the owner's painted gesture strips.  A MIRROR of GESTURE_TOOLS in
   ...
   v2.3.2760: the button no longer plays these whole (the mini tool below is
...
/* ═══ v2.3.2760: THE MINI TOOL -- "a mini sprite of the tool being used" ═══
