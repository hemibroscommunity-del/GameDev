 ...
 */
/* ═══ v2.3.2748: THE CUE GESTURE, THE WAY THE OWNER DESCRIBED IT ═══
 *
 ...
 *    in under ~2.4s.  (v2.3.2749: DOUBLED at the owner's word -- ~6s, floor
...
/* v2.3.2749 (owner, after playing it: "Double the amount of time it takes to
 ...
 * v2.3.2748: the bar no longer stalls at 95%.  The owner's description is two
...
/* v2.3.2245: the owner's painted gesture strips.  A MIRROR of GESTURE_TOOLS in
   ...
   v2.3.2748: the button no longer plays these whole (the mini tool below is
...
/* ═══ v2.3.2748: THE MINI TOOL -- "a mini sprite of the tool being used" ═══
