...
/* v2.3.2738: also on the shared-domain cookie, so a new preview-deploy
...
/* v2.3.2738: who the welcome is for.  The same test QuestCoach's preTutorial
 ...
 *
 *  ═══ v2.3.2738: AND ONLY FOR A PLAYER WHO IS ACTUALLY NEW ═══
  ...
  try {
    ...
    const check = function () {
      try {
        ...
        /* no getter (an old caller): the pre-v2.3.2738 behaviour */
