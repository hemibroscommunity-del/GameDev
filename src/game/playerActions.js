...
export function specialAttack(S) {
    ...
    if (activeWpn.type === 'bow') {
      ...
      S.arrows.push({
        ...
        isStaff: false,
        pierce: true,
        _rangeMult: bowRangeMult(R || {}) * depthK(S.currentZone, S.player.y), /* v2.3.2592: the special reaches as far as an ordinary arrow does; v2.3.2775 x depth */
      ...
      if (S.channel) S.channel.send({ type: 'broadcast', event: 'player_projectile', payload: {
        ...
        life: Math.round(90 * (bowRangeMult(R || {}) || 1) * depthK(S.currentZone, S.player.y)), /* v2.3.2592: peers see the stat's reach too; v2.3.2775 x depth */
      }});
      ...
      var _ORB_RANGE_PX = STAFF_RANGE_PX * staffRangeMult(R || {}) * depthK(S.currentZone, S.player.y); /* v2.3.2592: × the Magic lane's RANGE stat; v2.3.2775: × your depth */
