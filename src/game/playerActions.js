...
import { STAFF_RANGE_PX, staffRangeMult, bowRangeMult, STAFF_BIG_BOLT_ORBS } from '@/data/gameSystems.js'; /* v2.3.2387; v2.3.2592: the RANGE stat; v2.3.2715: the one-bolt special */
...
export function specialAttack(S) {
    ...
    if (activeWpn.type === 'bow') {
      ...
      /* ═══ v2.3.2715: ONE BIG BOLT (gameSystems STAFF_BIG_BOLT_*) ═══
