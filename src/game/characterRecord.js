...
import { setEyewearColor } from '@/rendering/traits/eyewearColorCatalog.js';   /* v2.3.2422 */
...
const LOOK_SETTERS = {
  ...
  ewc: setEyewearColor,   /* v2.3.2422: beside htc, its exact counterpart -- a colour the pair no longer offers renders native (eyewearColorTarget), so a retired swatch cannot show a look the picker refuses */
  st: setShirt,
  stc: setShirtColor,
  pt: setPants,
  sh: setShoes,
