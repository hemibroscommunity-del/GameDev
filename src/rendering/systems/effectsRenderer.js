...
/* v2.3.2700: ONE sheet now -- the snowman's ice-burst plume is retired (see
...
/* ═══ v2.3.2700: THE SNOWMAN'S ICE-BURST PLUME IS RETIRED ═══
   ...
   snowman's height.  Since v2.3.2699 a hit on a snowman throws crisp packed-snow
...
export class EffectsRenderer {
  ...
  /* v2.3.2700: the snowman's per-hit plume is retired (tombstone near the old
