...
const _STAND_IN_TRAIT_KEYS = ['capeBack', 'hair', 'beard', 'capeHood', 'capeHoodMask', 'species', 'eyestyle', 'eyewear', 'hat', 'hairMask'];   /* v2.3.2361: + eyewear, over the hood and under the hat -- this order IS the z-order when the set changes layer; v2.3.2643: + eyestyle, just under the eyewear; v2.3.2681: + species, just under the eye style */
...
export class EffectsRenderer {
  constructor(layers) {
    ...
    this.skillTraits = { capeBack: new Sprite(), hair: new Sprite(), beard: new Sprite(),
      capeHood: new Sprite(), capeHoodMask: new Sprite(), species: new Sprite(), eyestyle: new Sprite(), eyewear: new Sprite(), hat: new Sprite(), hairMask: new Sprite() };   /* v2.3.2361: + eyewear; v2.3.2643: + eyestyle; v2.3.2681: + species */
  ...
  _updateRemoteExtraction(S, now) {
    ...
    for (const id in others) {
      ...
      if (!ent.traits) {
        ...
        ent.traits = { hair: mk(), beard: mk(), species: mk(), eyestyle: mk(), eyewear: mk(), hat: mk() };   /* v2.3.2681: + species, under the eye style */   /* v2.3.2361: + eyewear, under the hat; v2.3.2643: + eyestyle, under the eyewear */
      }
      const looks = {
        ...
        species: o.species, skin: o.skin,                    /* v2.3.2681: the species' fur follows THEIR skin */
  ...
  _updateRemoteSwordSwings(S, now) {
    ...
    for (const [id, set] of this._remoteSwordSprites) {
      ...
      if (!others[id]) {
        for (const s of [set.jogLegs, set.jogLegsGear, set.body, set.shirt, set.legs, set.chest, set.weapon, set.traits.hair, set.traits.beard, set.traits.species, set.traits.eyestyle, set.traits.eyewear, set.traits.hat]) {   /* v2.3.2361; v2.3.2643: + eyestyle; v2.3.2681: + species */
