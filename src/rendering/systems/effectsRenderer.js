...
export class EffectsRenderer {
  ...
  _placeJogLegs(jl, jg, opts) {
    ...
    if (gearFrame && jg) {
      ...
      const _gn = 256 / ((gearFrame.orig && gearFrame.orig.width) || (gearFrame.frame && gearFrame.frame.width) || 256);   /* v2.3.2733: orig -- the frame may be cropped (gearSheets packTrimmed) */
