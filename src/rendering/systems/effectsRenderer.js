...
export class EffectsRenderer {
  constructor(layers) {
    ...
    const SWORD_ART_VERSION = 1045;   // 1041: metal sword — north swing weapon strip re-arted (south/east pending); 951: removed baked white blade artifact from east swing body frame 5
