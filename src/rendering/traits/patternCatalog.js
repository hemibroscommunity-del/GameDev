...
export const PATTERN_CATALOG = [
  { id: 'stripe-v', name: 'Stripes', w: 4, h: 1, cell: 3, cells: '1100' },
  { id: 'stripe-h', name: 'Bands', w: 1, h: 4, cell: 3, cells: '1100' },
  {
    id: 'check', name: 'Checks', w: 4, h: 4, cell: 3, cells:
      '1100' +
      '1100' +
      '0011' +
      '0011',
  ...
  {
    id: 'diag', name: 'Diagonal', w: 4, h: 4, cell: 3, cells:
      '1100' +
      '0110' +
      '0011' +
      '1001',
...
const SLOTS = ['shirt', 'pants'];
const STORAGE_KEY = { shirt: 'bt-shirtpat', pants: 'bt-pantspat' };
...
for (const k of SLOTS) {
  ...
  try {
    ...
    if (saved && parsePattern(saved)) _active[k] = saved;
 ...
 *  if this catalog recognises it, otherwise ''. */
export function sanitizePattern(s) { return parsePattern(s) ? s : ''; }
...
export function patternKey(s) { return sanitizePattern(s) || 'none'; }
