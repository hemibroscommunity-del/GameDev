...
import { skinTarget, retintSkinPixels, poseSkinTarget } from '../playerSkins.js';   /* v2.3.2831: + poseSkinTarget */
...
export function getSpeciesBuild(id, skinId) {
  ...
  for (const k of Object.keys(art.strips)) {
    /* v2.3.2831: the hit strips' fur was painted in the hit sheets' orange, and
