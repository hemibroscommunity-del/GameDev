...
export async function initPixiRenderer(canvas) {
  ...
  const entityRenderer = new EntityRenderer(layers.entities, layers.player, layers.monsterUi, layers.gestureFront, layers.gatherNodesFront, layers.foreground); /* v2.3.2648: + the near-camera layer */
