...
export function preloadGear() {
  ...
  /* v2.3.2462: + 'dodge', which v2.3.1573 shipped gear sheets for and never
     ...
     only the contextual dodge could reach it; the sword dash (v2.3.2462) now
