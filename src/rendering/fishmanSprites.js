/* Fishman variant sprite loader for the Tidal Caves brute slot.
 *
 ...
 * frame -- the fishman translates around the map while always
...
export function loadFishmanSprites() {
  if (loadPromise) return loadPromise;
  const tasks = WALK_DIRS.map((d) => loadStrip(`/sprites/monsters/fishman/walk-${d}.png?v=${SPRITE_VERSION}`, d));
