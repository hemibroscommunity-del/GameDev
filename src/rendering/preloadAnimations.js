...
import { effectsAnimationsReady, ensureSnowballBurstTex, freeFrostImpactTex, ensureArrowBlastTex } from './systems/effectsRenderer.js'; /* v2.3.2272: the frost-only sheets get an exit; v2.3.2743: minus the retired snowman plume */
...
export async function preloadZoneAssets(zoneId) {
  ...
  /* frost is the only snowman zone — its sprites load here instead of
     globally.  v2.3.2743: the ice-burst impact sheet that used to ride along
