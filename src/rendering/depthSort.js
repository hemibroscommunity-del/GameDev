...
/* ═══ v2.3.2718: EVERYTHING SORTS BY WHERE IT TOUCHES THE GROUND ═══
...
export function applyGroundSort(layer) {
  ...
  for (let i = 0; i < kids.length; i++) {
    ...
    /* v2.3.2718: a figure standing in front of a building's real base is
...
/**
 * v2.3.2718: the raise.  For every figure whose body can overlap a prop's art
 ...
 *                                (v2.3.2718 -- see the note above groundOf)
