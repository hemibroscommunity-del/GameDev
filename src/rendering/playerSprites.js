...
import { recolorToolKeyCanvas, recordFishRodMask, TOOL_SPECS } from './toolRecolor.js'; /* v2.3.2719: the fishing rod's pine */
...
async function loadSheet(pose, dir, attempt = 0) {
  ...
  try {
    ...
    /* ═══ v2.3.2719: THE ROD IS PINE, NOT THE PIPELINE'S MAGENTA KEY ═══
