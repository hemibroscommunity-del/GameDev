...
import { lifeKindFor } from './bagLife.js'; /* v2.3.2785: the portrait's small motion */
...
export const ItemDetailPopup = () => {
    ...
    if (slot === 'weapon') {
      ...
      const mkGearRow = (gearId, on, stashObj) => ({
        ...
        toggle: () => {
          ...
          BT_AUDIO.uiEquip();   /* v2.3.2639: deduped.  v2.3.2659: gain + offset in uiEquip */
          if (on) {
  ...
  /* v2.3.2785: the portrait lives the way the item does in the bag -- a potion
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 14px 30px rgba(4,7,9,.38)',
          opacity: pos ? 1 : 0,
          /* v2.3.2785: a quick fade rather than a pop.  Opacity only: the
      ...
      >
        ...
        <div style={{ position: 'relative', width: 80, height: 80, alignSelf: 'center' }}>
          ...
          {/* v2.3.2785: the portrait PRESENTS the item when the card opens
