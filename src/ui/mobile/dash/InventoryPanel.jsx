...
import { playVw, panelVw } from '../playViewport.js';
...
import { lifeKindFor, lifeKindForGear } from './bagLife.js';   /* v2.3.2755: the bag's small motions */
...
export const ItemTile = ({ ikey, count, style: styleOverride }) => {
  ...
  /* v2.3.2755: how this item comes alive in the bag (bagLife.js) -- a potion
  ...
  return (
    <div onPointerUp={handleTap} data-inv-key={ikey} data-bag-key={`i-${ikey}`} style={{
      ...
      {/* v2.3.2755: the glint and the arrival ring draw here (game.css) */}
...
const StashTile = ({ kind, obj, index, style: styleOverride }) => {
  ...
  return (
    ...
    <div onPointerUp={handleTap} className={rarityClass} data-tut="coach-gear" data-bag-key={`${kind}-${index}`} style={{
      ...
      {/* v2.3.2755: gear catches the light now and then (bagLife.js); a
