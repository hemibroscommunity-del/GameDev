        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 6 }}>
          {items.map(it => (
            <div key={it.id} onClick={() => onPick(it)} style={{
              padding: 8, background: 'rgba(34, 48, 60, .04)', borderRadius: 8,
              border: '0.5px solid rgba(34, 48, 60, .15)', cursor: 'pointer',
...
const ShortcutSlot = ({ idx, item, onTap }) => {
  ...
  return (
    <div onClick={() => onTap(idx)} style={{
      ...
      background: empty ? 'rgba(34, 48, 60, 0.03)' : 'rgba(80, 140, 200, 0.15)',
      border: empty
        ? '1.5px dashed rgba(34, 48, 60, 0.16)'
      ...
      {empty
        ? <div style={{ color: 'rgba(34, 48, 60, 0.32)', fontSize: 14 }}>+</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 6 }}>
          {items.map(it => (
            <div key={it.id} onClick={() => onPick(it.id)} style={{
              padding: 6, background: 'rgba(34, 48, 60, .04)', borderRadius: 8,
              border: '0.5px solid rgba(34, 48, 60, .15)', cursor: 'pointer',
              display: 'flex', flexDirection: 'column', alignItems: 'center',
            }}>
  ...
  <div onClick={onClose} style={{
    ...
    <div onClick={e => e.stopPropagation()} style={{
      ...
      <div onClick={() => { inventoryBus.clearShortcut(slotIdx); onClose(); }} style={{
        ...
        textAlign: 'center', borderBottom: '0.5px solid rgba(34, 48, 60, .1)', cursor: 'pointer',
      }}>Remove shortcut</div>
      <div onClick={onClose} style={{
    ...
    <div style={{ padding: 14 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          color: 'rgba(34, 48, 60, 0.78)', fontFamily: FONT.sans,
        }}>SHORTCUTS</div>
        <div style={{
          fontSize: 10, color: 'rgba(34, 48, 60, 0.45)', fontFamily: FONT.sans,
