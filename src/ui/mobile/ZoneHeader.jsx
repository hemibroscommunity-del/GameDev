...
import { calm as lifeCalm } from './dash/bagLife.js'; /* v2.3.2785: the purse's coin flip */
...
export const ZoneHeader = ({ onExit }) => {
  ...
  const goldSeen = useRef(null);   /* v2.3.2785: the purse's coin flip */
  ...
  /* v2.3.2785: gold landing spins the coin and bumps the number, once per
