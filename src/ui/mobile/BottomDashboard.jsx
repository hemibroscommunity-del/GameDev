...
import { bagLife, startBagLife } from './dash/bagLife.js'; /* v2.3.2795: the bag's small motions */
...
export const BottomDashboard = () => {
  ...
  useEffect(() => {
    let prev = null;
    /* v2.3.2795: stack sizes too, so a growing stack can bump its count */
    let prevCount = null;
    const tick = () => {
      ...
      /* v2.3.2795: the same "new key" that badges the pickup also pops it
