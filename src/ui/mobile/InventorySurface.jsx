      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        {opts.map(([k, label]) => (
          <div key={k} onClick={() => onPick(k)} style={{
            ...
            borderBottom: '0.5px solid rgba(238, 242, 235, .05)',
            cursor: 'pointer',
          }}>{label}</div>
        ))}
      </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'rgba(238, 242, 235, 0.07)', border: '0.5px solid rgba(238, 242, 235, 0.12)',
          borderRadius: 8, display: 'flex', alignItems: 'center', gap: 8,
        }}>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(238, 242, 235, 0.45)" strokeWidth="2">
      ...
      <div style={{
        ...
        <div style={{
          ...
          {['inventory', 'equipped'].map(t => {
            ...
            return (
              <div key={t} onClick={() => inventoryBus.setTab(t)} style={{
                ...
                color: active ? '#fff' : 'rgba(238, 242, 235, 0.62)',
                fontFamily: FONT.sans, fontSize: 14, fontWeight: active ? 500 : 400,
              }}>
                {t === 'inventory' ? 'Inventory' : 'Equipped'}
                {t === 'inventory' && (
                  <span style={{ fontFamily: FONT.mono, fontSize: 12, color: 'rgba(238, 242, 235, 0.55)' }}>{totalCount}</span>
                )}
                {active && (
          ...
          <div onClick={() => inventoryBus.setOpen(false)} style={{
            ...
            color: 'rgba(238, 242, 235, 0.62)', fontSize: 22, cursor: 'pointer',
