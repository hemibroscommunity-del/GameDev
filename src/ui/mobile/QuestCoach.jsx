...
import { coachMayShow, noteCoach, tutorialSkipped } from '@/ui/onboardingPace.js'; /* v2.3.2766; v2.3.2880 + the skip */
...
export function QuestCoach(props) {
  ...
  React.useEffect(function () {
    ...
    const step = function () {
      ...
      /* v2.3.2880: skipping the tutorial retires the coach like finishing it
