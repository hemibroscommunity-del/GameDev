...
import { buildSkillUnspent, STAT_TO_WEAPON_CAT, getActiveWeapon, weaponForCat, swingCooldownMultFor } from '../../../data/gameSystems.js'; /* v2.3.1914: getActiveWeapon; v2.3.2231: weaponForCat; v2.3.2432: swingCooldownMultFor */
...
import {
  ...
  prog3CritMult, prog3CritPct /* v2.3.2432 */ } from '../../../data/prog3.js';
      ...
      {section === 'Build' && p3 && (
        <>
          {(() => {
            ...
            /* ═══════════════════════════════════════════════════════════
               v2.3.2432: THE DENSE GRID — 4 + 3 + 2 IN THE SAME FOOTPRINT
               ═══════════════════════════════════════════════════════════
              ...
              {landPane ? (
                    ...
                    return (
                      <div
                        ...
                        <span style={{
                          ...
                          /* v2.3.2432: the reserved corner is GONE with the
                        ...
                        {/* ═══ v2.3.2432: THE SECOND LINE IS THE POINTS ═══
                ...
                {!laneClosed && (
                  <div id="bt-prog3-body" style={{
                    display: 'flex',
                    /* v2.3.2382 made this a ROW of two columns.  v2.3.2432
                    ...
                    {prog3TwoCol ? (
                      <>
                        {/* ═══ v2.3.2432: 4 + 3 + 2, ONE COLUMN OF THREE BANDS ═══
