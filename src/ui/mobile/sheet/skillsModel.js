...
const META = {
  woodcutting:   { icon: '🪓', name: 'Woodcutting',  iconSrc: '/icons/ui/skill-woodcutting.webp?v=2.3.1224',  group: 'gather',  accent: '#8FBF6A', iconScale: 1.15, tiers: WOODCUTTING_TIERS, tierNoun: (t) => t.tree, where: 'Frost Shore', passive: (lvl) => 'Node extraction opens 0.25s sooner per level above its tier', earnHint: 'Chop trees in the wild — higher-level trees give more XP.' },
