...
const state = {
  ...
  /* v2.3.613: armor is chest + legs (helmet removed).  Each maps to a gear
     render slot via the GameApp bridge. */
  equipped: { weapon: null, chest: null, legs: null, pet: null, tool: null },
