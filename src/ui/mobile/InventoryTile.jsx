    ...
    <div onClick={onTap} className={RARITY_CLASS[item.quality] || ''} style={{
      ...
      {layer3 && item.crafter && (
        <div style={{
          ...
          fontSize: 11, color: 'rgba(232,212,160,0.7)', fontFamily: FONT.mono, /* v2.3.1239: 10px font floor (was 8) */
      ...
      <div style={{
        ...
        <div style={{
          flexShrink: 0, fontSize: 11, color: 'rgba(238, 242, 235, 0.65)', /* v2.3.1239: 10px font floor (was 9) */
