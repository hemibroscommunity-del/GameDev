...
export function TouchControls(props) {
  var stateRef = props.stateRef,
    ...
    rHintRef = props.rHintRef,   /* v2.3.2384: the gesture cue; v2.3.2760: the mini tool */
  ...
  })), /* v2.3.2760: the painted tool STRIP that played on the button face since
  ...
  /*#__PURE__*/React.createElement("div", {
    ...
    /* ═══ v2.3.2760: THE CUE IS A MINI TOOL ═══
