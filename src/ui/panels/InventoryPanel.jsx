...
export function InventoryPanel(props) {
  ...
  return React.createElement("div", {
    ...
    { slot: 'chest', name: 'Steel Plate', sub: 'Chest', icon: '/icons/items/chest-plate.webp?v=2.3.1325b' }, /* v2.3.1325: painted item set */
    { slot: 'legs', name: 'Steel Greaves', sub: 'Legs', icon: '/icons/items/greaves.webp?v=2.3.1325b' },
    /* v2.3.756: the t-shirt layer -- worn UNDER the chest armour (both can
       be on at once; armour always renders on top). */
    { slot: 'shirt', name: 'T-Shirt', sub: 'Chest \u00b7 under armor', icon: '/icons/items/cloth-shirt.webp?v=2.3.1325b' }
  ].map(function (it) {
