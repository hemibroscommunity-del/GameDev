...
import { BT_AUDIO, calcBlockReduction, calcCritChance, calcCritMult, calcDisplayDmgRange, calcMoveSpeed, getActiveWeapon, getDefenseBlockBonus, getWeaponCritDmgStat, getWeaponCritStat, weaponXpRequired, xpRequired, toDisplayHp } from '@/data/index.js'; /* v2.3.2502: the display damage scale */
...
export function StatScreenPanel(props) {
  ...
  /* v2.3.2502: HP is scaled (§5.8 D2); STA and MP are NOT. */
