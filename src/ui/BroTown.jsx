...
import { GESTURE_CUE_SPRITES, gestureCueFace, gestureIdle, extractionMeter01 } from '@/game/gesturePose.js'; /* v2.3.2702: the mini-tool cue on the button (it replaced v2.3.2245's strip and v2.3.2384's finger); extractionMeter01 v2.3.2514 (shared with the bar above the head) */
...
export var BroTown = function BroTown(_ref0) {
    ...
    var _gameLoop = function gameLoop() {
      ...
      try {
           ...
           because these change every frame while the loop already runs. */
        {
          ...
          /* ═══ v2.3.2702: THE CUE -- A MINI TOOL, STILL AND FLASHING UNTIL YOU MOVE ═══
  ...
  var rHintRef = useRef(null);    /* v2.3.2384: the gesture cue; v2.3.2702: a mini tool (the strip's rCueRef is gone) */
