...
export var BroTown = function BroTown(_ref0) {
  ...
  window._gameFns = {
    ...
    /* v2.3.2773: warm a zone's monster art from wherever the player stands,
    ...
    monsterTorsoY: DATA.monsterTorsoY,   /* v2.3.2775: where a locked shot is aimed and lands (mp-shotland) */
