...
/* v2.3.1175: party roster + invite popup (handoff item D).  NOT the
   arena's buildings/PartyPanel — that name predates real parties. */
import { PartyRosterPanel } from './panels/PartyRosterPanel.jsx';
...
export var BroTown = function BroTown(_ref0) {
  ...
  /* v2.3.1175: party roster snapshot (server truth from party_state)
     or the incoming-invite stub ({invite:true, from, fromName}). */
