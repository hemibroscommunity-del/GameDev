...
export var BroTown = function BroTown(_ref0) {
  ...
  }, "Cancel"))), questPanel && rpgState && /*#__PURE__*/React.createElement(QuestPanel, { rpgState: rpgState, stateRef: stateRef, questPanel: questPanel, setQuestPanel: setQuestPanel, setRpgState: setRpgState }), duelRequest && /*#__PURE__*/React.createElement("div", {
    className: "bt-inspect",
    onClick: function onClick() {
  ...
  }, "If you ignore, their skull turns white \u2014 anyone can attack them freely but you keep equipped items. If you call guards, they lose 10% gold and gear is locked for 30 minutes."))), showTrade && tradeTarget && rpgState && /*#__PURE__*/React.createElement(TradePanel, { rpgState: rpgState, stateRef: stateRef, tradeTarget: tradeTarget, tradeOffer: tradeOffer, setShowTrade: setShowTrade, setTradeOffer: setTradeOffer }), incomingTrade && rpgState && /*#__PURE__*/React.createElement("div", {
    className: "bt-inspect",
    onClick: function onClick() {
