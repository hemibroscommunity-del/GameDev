  ...
  useEffect(function () {
    ...
    var _gameLoop = function gameLoop() {
      ...
      try {
        ...
        if (S._zoneLoading || S._netHold || S._townArtHold) finalSpd = 0;   /* v2.3.2439: _netHold — veiled, waiting for the server (serverReady.js); v2.3.2792: _townArtHold — veiled while town's NPCs load (zoneTransitions syncTownScenery) */
