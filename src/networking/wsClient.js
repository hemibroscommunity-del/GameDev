...
import { toDisplayDamage } from '@/data/gameSystems.js'; /* v2.3.2502: the display damage scale */
          ...
          case 'lifesteal_credit':
            {
              ...
              if (msg.payload && msg.payload.refund > 0 && S.dmgNumbers && S.player) {
                pushDmgPopup(S, S.player.x, S.player.y - 40, '+' + toDisplayDamage(msg.payload.refund) + ' HP', '#3dd497');   /* v2.3.2502: display scale */
              }
