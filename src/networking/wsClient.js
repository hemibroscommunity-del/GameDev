          ...
          case 'loot_pickup_rejected':
            {
              ...
              /* ═══ v2.3.2531: THE THIRD KIND OF NO, WHICH HAD NO HANDLER ═══
              ...
              if ((msg.payload.reason === 'out-of-range' || _rjPermanent || _rjTransient) && msg.payload.lootId && S.groundLoot) {
                for (var _rjI = 0; _rjI < S.groundLoot.length; _rjI++) {
                  ...
                  /* ═══ v2.3.2531: EIGHT FAST TRIES, NOT EIGHT FOR ALL TIME ═══
      ...
      */
      function _applyLootCredit(payload, S) {
        ...
        if (payload.coins && payload.coins > 0) {
          ...
          /* v2.3.2531: dev probe, house style (cf. window.__btLootSprites) and
    ...
    var channelShim = {
      send: function send(msg) {
        ...
        if (msg.type === 'loot_pickup') {
          /* ═══ v2.3.2531: THE PICKUP IS MEASURED FROM ps, SO SEND ps FIRST ═══
