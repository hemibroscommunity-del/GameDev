...
import { getEyeStyle } from '@/rendering/traits/eyeStyleCatalog.js';   /* v2.3.2643 */
import { getSpecies } from '@/rendering/traits/speciesCatalog.js';   /* v2.3.2682 */
      ...
      ws.onopen = function () {
        ...
        ws.send(JSON.stringify({
          ...
          data: {
            ...
            es: getEyeStyle(),   /* v2.3.2643: the eye style, and the same degrade -- an old worker drops it and peers see the default eyes */
            sc: getSpecies(),   /* v2.3.2682: the species, and the same degrade -- an old worker drops it and peers see a human with a fur-coloured skin */
            st: getShirt(),
            stc: getShirtColor(),
          ...
          case 'state_sync':
            {
              ...
              try {
                ...
                /* v2.3.2756: Wind Dunes' depth curve draws only while THIS
