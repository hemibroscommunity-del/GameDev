          ...
          case 'monster_ability':
            {
              ...
              if (payload.ability === 'burst') {
                ...
                if (payload.phase === 'swell') {
                  ...
                  /* ═══ v2.3.2912: A SHOCKWAVE, AND THE SHAKE ONLY IF IT GOT YOU ═══
          ...
          case 'player_dodge':
            {
              ...
              if (payload.id && _peerInZone(S, payload.id)) {
                ...
                S.others[payload.id]._dodgeRoll = {
                  ...
                  /* v2.3.2918: whether they were walking when it started
                     ...
                     kept; absent (an older client) = undefined, and the print
                     rule falls back to their relayed velocity. */
                  walk: typeof payload.walk === 'boolean' ? payload.walk : undefined,
                };
