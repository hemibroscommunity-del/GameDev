...
import { enqueuePeerDamage, peerDmgKey, distributeKillXpToBuild, applyMeleeLifesteal, addBuildUse, pushDmgPopup, monsterPopupY, isAttackInShieldArc, spawnHitDebris /* v2.3.2200; v2.3.2803: its decal twin is retired here */, propSwingHit /* v2.3.2730 */ } from '@/game/combatHelpers.js';
          ...
          case 'player_projectile':
            {
              ...
              /* v2.3.2801: a peer's basic staff bolt drives THEIR staff kick and
              ...
              if (S.monsters) {
                ...
                if (hitM) {
                  ...
                  if (payload.attackerId !== S.myId || payload.ability || payload.thorns || payload.burst
                    ...
                    /* v2.3.2803: the worker names the slot that dealt it
                  ...
                  /* v2.3.2804: the peer half of the snowman's ice-burst plume
                  ...
                  /* v2.3.2804: the three flat dots that used to follow here
