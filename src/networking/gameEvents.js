...
import { pushAbilityRings, BASH_POSE_MS } from '@/game/abilities.js'; /* v2.3.1735: a peer's bash draws the caster's own shockwave; v2.3.2903 + its pose window */
          ...
          case 'player_swing':
            {
              if (payload.id && _peerInZone(S, payload.id)) {
                ...
                /* v2.3.2903: ...and for how long, so the watcher holds THEIR
