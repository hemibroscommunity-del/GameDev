...
/* ═══ v2.3.2803: `fx`, WHAT THE HIT LOOKS LIKE, APART FROM `kind` ═══
...
const HIT_MATERIALS = {
  ...
  fodder:        { kind: 'goo',   tint: 0x3dd497, fxTint: 0x5ca84c /* v2.3.2803: the slime sheet's own green, sampled */, decal: '#1f7a55' },
 ...
 * the sprite (fodder's was minty teal on a grass-green sheet until v2.3.2803
