...
export const ZONES = {
  ...
  ember: {
    id: 'ember', name: 'Ember Fields', w: 50, h: 40,
  ...
  mist: {
    id: 'mist', name: 'Mistwood', w: 50, h: 40,
  ...
  frost: {
    id: 'frost', name: 'Frozen Shore', w: 50, h: 40,
  ...
  thunder: {
    id: 'thunder', name: 'Thunder Peaks', w: 50, h: 40,
  ...
  hollows: {
    id: 'hollows', name: 'Deep Hollows', w: 50, h: 40,
  ...
  sky: {
    id: 'sky', name: 'Sky Reaches', w: 50, h: 40,
  ...
  tidal: {
    id: 'tidal', name: 'Tidal Caves', w: 50, h: 40,
