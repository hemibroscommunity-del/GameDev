...
export const ZONES = {
  ...
  meadow: {
    ...
    spawns: [{ arch: 'fodder', count: 6 }] /* v2.3.2231: six per zone (mirror of server/src/data.js) */
  },
  ember: {
  ...
  mist: {
    ...
    spawns: [{ arch: 'fodder', count: 4 }, { arch: 'brute', count: 2 }],   /* v2.3.2231: six per zone (mirror of server/src/data.js) */
  ...
  verdant: {
    ...
    spawns: [{ arch: 'fodder', count: 6, variant: 'blueSlime' }],   /* v2.3.2231: six per zone (mirror of server/src/data.js) */
  ...
  frost: {
    ...
    spawns: [{ arch: 'snowman', count: 6 }],   /* v2.3.2231: six per zone (mirror of server/src/data.js) */
  ...
  hollows: {
    ...
    spawns: [{ arch: 'brute', count: 6 }],   /* v2.3.2231: six per zone (mirror of server/src/data.js) */
  ...
  sky: {
    ...
    spawns: [{ arch: 'stalker', count: 2 }, { arch: 'hexer', count: 2 }, { arch: 'volatile', count: 2 }],   /* v2.3.2231: six per zone (mirror of server/src/data.js) */
