...
export const WORLD_PROPS = [
     ...
     `mapV` gates placement (see propIsPlaced): 17 is the map that ships. */
  {
    ...
    /* v2.3.2751: the -still art -- its two flags cut out to wave on their
  ...
  },
  {
    ...
    /* v2.3.2751: -still: the hanging sign cut out to swing, the painted
  ...
  },
  {
    ...
    /* v2.3.2751: -still: the sign, the banner, the scales and the flag cut
  ...
  {
    /* v2.3.2751: -still: the coin crate and both flags cut out to move
