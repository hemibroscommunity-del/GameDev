...
const JOIN_COSMETIC_KEYS = [
  ...
  /* v2.3.2424: `pb` is the BACK OF THE TROUSERS -- the pants print's other
...
export const DRAWING_KEYS = new Set(['sa', 'sb', 'pa', 'pb', 'ta', 'tf', 'tm', 'tb', 'tr']);   /* v2.3.2043: +tb; v2.3.2148: +tr, the back of the body; v2.3.2424: +pb, the back of the trousers */
