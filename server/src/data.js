...
export const ZONES = {
      ...
      sky:     { w:32, h:32, level:[1,2], element:'wind',  secondary:'frost', lawless:true, spawns:[{arch:'stalker',count:2},{arch:'hexer',count:2},{arch:'volatile',count:2}],
                 depth:{ axis:'y', near:1, far:0.42, curve:1 } /* v2.3.2756: the north-south perspective ramp -- MIRROR of src/data/zones.js sky.depth (minus its client-only `preview`), read by depth.js; zonedepth.test holds the two in lockstep */ }, /* band: [38,58] */
