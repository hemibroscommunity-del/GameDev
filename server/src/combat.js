...
export const combatMethods = {
  ...
  _handleMonsterDamage(session, payload) {
    ...
    /* ═══ v2.3.2741: ONE BIG STAFF BOLT, THREE ORBS' WORTH ═══
    ...
    if (attackerPs) {
      ...
      if (isSpecial) {
        ...
        /* v2.3.2741: a big bolt spends one slot per orb it carries, and never
    ...
    /* v2.3.2741: a big staff bolt's other orbs (see `_orbs` above) -- each its
