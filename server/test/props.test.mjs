   ...
   blocker, which is the shape of use the old tests never exercised. */
{
  ...
  check('fixture: frost has blockers to fly through', boxes.length >= 3, { n: boxes.length });   /* v2.3.2877: three snowbanks (was six props) */
   ...
   material the debris and the sound can use. */
{
  ...
  /* out of reach.  Asked about the RIDGE, not about anything: 120px south of
     ...
     tripped over.  (v2.3.2877: the pines are gone; the check stays asked
     about the ridge.) */
  ...
  /* v2.3.2877: frost's pines are gone -- its three snowbanks are the rock
