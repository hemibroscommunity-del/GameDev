...
// position exclusion (TRACK_STATE_EXCLUDED) in index.js.
{
  ...
  await room.webSocketMessage(wsT, JSON.stringify({
    ...
    data: {
      ...
      ewc: 'red',    /* v2.3.2422: the eyewear's colour */
    },
  }));
  ...
  /* v2.3.2422: and its COLOUR, asserted on its own line rather than folded
  ...
  check('track: the eyewear COLOUR is relayed too (v2.3.2422)', psT.ewc === 'red', psT.ewc);
