"""CUT THE MOVING PARTS OUT OF THE TOWN BUILDINGS  (v2.3.2812).
...
# the auction house's banner, v2.3.2812).  So along every hang cut the piece
...
def main():
    ...
    js = [
        ...
        '   SPECS there and re-run it.  v2.3.2812: the town buildings\' moving parts.',
        '',
