"""CUT THE MOVING PARTS OUT OF THE TOWN BUILDINGS  (v2.3.2752).
...
# the auction house's banner, v2.3.2752).  So along every hang cut the piece
...
def main():
    ...
    js = [
        ...
        '   SPECS there and re-run it.  v2.3.2752: the town buildings\' moving parts.',
        '',
