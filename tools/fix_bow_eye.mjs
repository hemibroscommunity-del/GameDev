...
/* v2.3.2473: was a hard-coded path from the session that wrote this file, which
...
/* ═══ v2.3.2473: FRAME 2 IS NOT FINE, AND THE NOTE BELOW IS WHY IT LOOKED IT ═══
...
function processFrame(d,W,x0,fw){
  ...
  /* TWO defects, one repair.  v2.3.961's was an oversized WHITE BLOCK sclera on
     the camera-left eye; v2.3.2473's (frame 2) is the opposite -- that eye is
