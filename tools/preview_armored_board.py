...
# --- keep in sync with src/rendering/systems/entityRenderer.js (v2.3.584) ---
BODY_DIR_SCALE = {
...
STAND_HEIGHT = {'south': 0.960, 'east': 0.966, 'north': 1.064, 'northeast': 0.998, 'southwest': 0.931}
...
ap.add_argument('--out', default='tools/armored-board-v2.3.584.png')
a = ap.parse_args()
...
dr.text((6, 6), 'v2.3.584', fill=(255, 255, 0, 255))
