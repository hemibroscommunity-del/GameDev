...
# --- keep in sync with src/rendering/systems/entityRenderer.js (v2.3.587) ---
BODY_DIR_SCALE = {
...
ap.add_argument('--out', default='tools/armored-board-v2.3.587.png')
a = ap.parse_args()
...
dr.text((6, 6), 'v2.3.587', fill=(255, 255, 0, 255))
