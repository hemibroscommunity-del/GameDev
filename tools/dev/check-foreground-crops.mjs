/* EVERY PRE-CUT EDGE OF A FOREGROUND PIECE MUST LIE OUTSIDE THE MAP (v2.3.2648).
 *
 ...
 *
 * WHY THIS IS A SCRIPT AND NOT AN ASSERTION IN THE SCENARIO.  v2.3.2648 put
...
/* Fraction of a canvas edge that must carry ink before it counts as a CUT,
   ...
   Across the three pieces shipped at v2.3.2648 the edge runs are:
