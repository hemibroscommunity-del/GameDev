...
export async function run({ browser, wsPort, webPort, rec }) {
  ...
  /* ═══ v2.3.2472: TWO OF THE FIVE ARE HIDDEN AGAIN, BY OWNER DECISION ═══
  ...
  rec.ok('...and it is OFF on the two poses that bend the torso flat -- the '
    + 'roll and the loot bend (owner D6, v2.3.2472). A cape pinned to the crown '
  ...
  const OFFSET_CAP = 24;
  /* v2.3.2472: asked of the poses that still DRAW a cape.  A hidden sprite has
