...
export async function run({ browser, wsPort, webPort, rec }) {
  ...
  const P = await H.newPlayer(browser, {
    ...
    init: SPOOF + ';window.__btInstallAfterMs=3000;delete window.__btCoachGapMs;',   /* v2.3.2865: the REAL 20s tutorial gap */
  });
  ...
  /* ═══ v2.3.2865: 20 SECONDS BETWEEN TUTORIAL POP-UPS ═══
