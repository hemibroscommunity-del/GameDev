/* THE STAFF CAST: CHARGE, RELEASE, A LIVING BOLT, A HOT HIT (v2.3.2740)
 *
...
export async function run({ browser, wsPort, webPort, rec }) {
  ...
  /* ════════════════ 1b. THE ONE-BOLT SPECIAL (v2.3.2715) ════════════════
  ...
  /* v2.3.2715: the watcher sees the caster's one-bolt special as their big
