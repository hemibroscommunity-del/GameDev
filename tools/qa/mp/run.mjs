...
const SCENARIOS = {
  hitmat: () => import('./mp-hitmat.mjs'), /* v2.3.2742: every monster throws its own material (snow, slime, blood + char, ashy dust, bone, stone), shaped by the weapon -- an arrow's jet, a bolt's blast, a blade's sheet -- and the pieces land */
  shotland: () => import('./mp-shotland.mjs'), /* v2.3.2743: a bolt or an arrow is drawn landing IN the body -- round its centre, spread over its core -- not on the ring its hit test registers on; the hit itself still registers there */
