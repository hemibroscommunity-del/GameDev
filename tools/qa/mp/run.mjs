...
const SCENARIOS = {
  sheen: () => import('./mp-sheen.mjs'), /* v2.3.2781: a permanent soft shine on metal behind ?sheen=1 -- off by default, on every frame when on, copper stays copper, the jogging full-set knight too; pictures and its cost */
