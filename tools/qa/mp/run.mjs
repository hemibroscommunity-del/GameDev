...
const SCENARIOS = {
  ...
  uisfx3: () => import('./mp-uisfx3.mjs'), /* v2.3.2642: click vs close routing, and no doubles */
  ...
  ability: () => import('./mp-ability.mjs'), /* v2.3.1733: the stamina abilities reach the worker (v2.3.2646: no milestone gate -- the ladder is gone) */
