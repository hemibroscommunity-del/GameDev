...
const SCENARIOS = {
  ...
  dodgetime: () => import('./mp-dodgetime.mjs'), /* v2.3.2898: a peer's roll plays over THEIR window (250-700 ms), frame for frame with their own screen, and ends when theirs does */
