...
const SCENARIOS = {
  ...
  animparity: () => import('./mp-animparity.mjs'), /* v2.3.2914: a peer's sword swing and bow shot are drawn the size, and on the boots, its owner sees -- every facing, several frames */
