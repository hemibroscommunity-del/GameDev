...
const SCENARIOS = {
  hitmat: () => import('./mp-hitmat.mjs'), /* v2.3.2699: every monster throws its own material (snow, slime, blood + char, ashy dust, bone, stone), shaped by the weapon -- an arrow's jet, a bolt's blast, a blade's sheet -- and the pieces land */
