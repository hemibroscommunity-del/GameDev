...
const SCENARIOS = {
  ...
  headink: () => import('./mp-headink.mjs'), /* v2.3.2833: the face tattoo stays on under the head overlays -- pickup, a hit or mining in armour, the full-steel knight, both sides and the back of the head, and a watcher's view */
