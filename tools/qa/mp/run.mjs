...
const SCENARIOS = {
  geartrim: () => import('./mp-geartrim.mjs'), /* v2.3.2746: gear frames cropped to their art -- under a third of the bytes, and every layer still lands exactly on the body, own screen and peer's */
