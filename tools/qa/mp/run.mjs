...
const SCENARIOS = {
  ...
  propdepth: () => import('./mp-propdepth.mjs'), /* v2.3.2718: in front of a prop or behind it by where your FEET are and where its art meets the ground; props stop your feet from behind; the owner's four screenshots as cases, each checked against the old rule */
  worldshadow: () => import('./mp-worldshadow.mjs'), /* v2.3.2719: props, trees and every monster on screen cast a shadow in each sunlit zone, and a building's shadow falls on its shaded side; pictures off/on */
