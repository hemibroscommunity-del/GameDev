...
const SCENARIOS = {
  peerattackink: () => import('./mp-peerattackink.mjs'), /* v2.3.2821: another player's swing and bow shot wear their drawings -- both sides, the back from behind, and the bow no longer borrows the sword's frames */
