...
const SCENARIOS = {
  bowgate: () => import('./mp-bowgate.mjs'), /* v2.3.2527: the bow's fire gate tests the ray the player is SHOWN -- measured after the player walks, which is when the two used to drift apart */
