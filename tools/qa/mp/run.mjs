...
const SCENARIOS = {
  ...
  liveness: () => import('./mp-liveness.mjs'), /* v2.3.2781-2785: trees sway, signs swing, flags wave, the forge smokes, people breathe, and the bag comes alive -- all still under the calm switch */
