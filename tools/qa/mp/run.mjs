...
const SCENARIOS = {
  ...
  campfirelife: () => import('./mp-campfirelife.mjs'), /* v2.3.2899: a cooking peer's fire stays lit on the watcher's screen as long as it does on theirs, and goes out on the same schedule */
