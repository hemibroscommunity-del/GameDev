...
const SCENARIOS = {
  ...
  chatlanes: () => import('./mp-chatlanes.mjs'), /* v2.3.2134: @area / @user across two real clients */
  deaddoor: () => import('./mp-deaddoor.mjs'), /* v2.3.2133: the depth door that cannot open */
