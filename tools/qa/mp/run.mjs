...
const SCENARIOS = {
  harvestink: () => import('./mp-harvestink.mjs'), /* v2.3.2751: tattoos stay on while fishing -- on both screens, the rod untouched, and a pink chest tattoo never lifted over the shirt */
