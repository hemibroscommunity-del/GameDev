...
import { propsForZone, foregroundForZone } from '../../../src/data/worldProps.js';   /* v2.3.2894: imports nothing, so node reads the tables */

const PHONE = { width: 390, height: 844 };
/* v2.3.2894: three snowbanks in a line, nothing else (owner: "the small zone
...
export async function run({ browser, wsPort, webPort, rec }) {
  ...
  /* v2.3.2894: counted by SPRITE, not by piece -- the three snowbanks share
  ...
  /* v2.3.2894: and they stand as one LINE with gaps in it -- cover, not a wall */
  ...
  /* v2.3.2894: through the game's own doors, back out of frost and home.
