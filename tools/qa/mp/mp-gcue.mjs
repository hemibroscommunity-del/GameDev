/* ═══ THE CUE GESTURE, AS THE OWNER DESCRIBED IT (v2.3.2718) ═══
 *
 ...
 *         (v2.3.2719: doubled from 3s / 2.4s at the owner's word).
 *
...
export async function run({ browser, wsPort, webPort, rec }) {
  ...
  /* v2.3.2719: a look at the fire-lighter mid-animation -- the log was the
