 ...
 * (v2.3.2808's volley; it was one), three orbs for the staff -- so a NORMAL
...
export async function run({ browser, wsPort, webPort, rec }) {
  ...
  const rows = [];
  for (const w of [
    { key: 'bow',   type: 'bow',   stash: 'rangedWeapon', slot: 'ranged', own: 3 },   /* v2.3.2808: the volley -- three arrows, one press */
