 ...
 *    v2.3.2784: the marks are the material's own landed pieces
...
export async function run({ browser, wsPort, webPort, rec }) {
  ...
  /* ── 3. ground marks ──
     v2.3.2784: the mark is the material's own pieces now.  A hit used to add a
  ...
  rec.ok('a hit leaves marks on the ground: its pieces land and lie there (v2.3.2784)',
