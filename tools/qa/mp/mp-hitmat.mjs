/* A MONSTER REACTS LIKE WHAT IT IS MADE OF (v2.3.2773).
 *
 ...
 *
 * v2.3.2774, the owner's follow-up: "remove the old blurry large hit effects"
...
/* v2.3.2774: the slime family, and the goo colour each must throw -- written
...
async function hitOnce(P, mat, wpn, dx, dy) {
  ...
  /* v2.3.2774: a bone shard bounces twice and skitters, so one thrown hard can
...
export async function run({ browser, wsPort, webPort, rec }) {
  ...
  /* v2.3.2774: every URL the page asks for, so the retired plume can be shown
  ...
  /* ── v2.3.2774: a slime sheds the colour it is drawn in ── */
  ...
  /* ── v2.3.2774: the snowman's painted plume is retired, not just hidden ── */
