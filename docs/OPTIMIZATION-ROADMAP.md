...
### Items 1-6, 9-15 SHIPPED (v2.3.2337-2355, v2.3.2750, v2.3.2774-2860); the rest is the ranked backlog
...
15. ~~**Monster strips — 27-40% empty cells, ~8 MB in Ember, ~7 in Desert
   Winds**~~ **SHIPPED, v2.3.2860** (measured, `mp-monstertrim`: the fire goblin
