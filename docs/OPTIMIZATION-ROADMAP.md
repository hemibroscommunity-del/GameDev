...
### Items 1-6, 9, 10, 11, 12, 13 and 14 SHIPPED (v2.3.2337-2355, v2.3.2750, v2.3.2774-2792); the rest is the ranked backlog
...
2. ~~**Town NPC walk strips + town props, held in every field zone — 25.3 MB
   in ember (0 in town), medium risk, medium.**~~ **SHIPPED, v2.3.2792**
