...
## 106. A gear frame's `frame` is the crop, not the frame (v2.3.2733)
...
consumer did exactly that until v2.3.2733, and it was right while every frame
was a whole 128 or 256 cell.

**Wrong** since v2.3.2733: gearSheets crops the walking-layer sheets
