...
nothing to DRAW -- Pixi builds the quad from `trim`. (v2.3.2860 correction: its
...
## 119. A cropped sprite's getBounds() is its art, not its frame (v2.3.2860)
...
monster strips (v2.3.2860) would have moved the stun ring and shrunk the night
glow.
