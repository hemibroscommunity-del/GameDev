...
| `dungeon_boss_ability` | v2.3.1194 boss ability telegraph/execute notice (private to players inside; client handler is display-only — damage rides `monster_attack`) | dungeons.md |
