# Tattoos stay on while you harvest (v2.3.2854, v2.3.2855)
...
| woodcutting | a separate lumberjack figure (`chop-strip`) | **gone**, on every screen | **on**, on every screen (v2.3.2855) |
