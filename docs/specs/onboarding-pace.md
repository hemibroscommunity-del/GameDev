# Onboarding pacing and the returning-player fix (v2.3.2765–2739)
...
## Returning players are not treated as new (v2.3.2765)
...
* The coach (`QuestCoach.jsx`), the welcome plate (`welcomeBanner.js`) and the
  ...
  level-1 default on the roads a returning player takes (TRAPS §109).
...
## One onboarding voice at a time (v2.3.2766)
