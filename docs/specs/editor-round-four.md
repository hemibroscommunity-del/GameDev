# The designer's fourth round (v2.3.2427–2430)
...
## 3 & 5. Letters have a size (v2.3.2427)
...
## 6. Recolour what you picked up (v2.3.2427)
...
## 7. The trousers get a back (v2.3.2428)
...
## 4. The shirt is designed on the shirt (v2.3.2430)
...
## 8. A swing and a raised shield wear your drawings (v2.3.2429)
