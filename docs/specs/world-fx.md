...
- **Lengths (v2.3.2882):** day ~28.7 min, golden hour 2.4, dusk 2, night 2.9, dawn 4. Night was ~11.6 min; the owner asked for a quarter of that, and the time went to day.
- **Top bar clock (v2.3.2882):** a small sun / low sun / horizon / moon icon sits left of the zone name (`TodIcon` in ZoneHeader.jsx, `data-tod` names the hour). Indoors and in dungeons it is dimmed, since the hour still passes but the world ignores it.
