# Sharp character pixels and the tee's shoulder line (v2.3.2741–2743)
...
## Sharp pixels (v2.3.2743)

* **Cause, measured with `window.__btSelfSprites()` (v2.3.2741):** the body and
